...
const envSchema = z.object({
  ...
  GDS_IMAGE_BASE_URL: z.string().url().default("https://oss.gds.org.cn"),
  GDS_GOODS_DIR: z.string().min(1).default("/data/static/goods"),
  GDS_GOODS_PUBLIC_BASE_URL: z.string().url().default("http://120.53.21.92:30990/goods"),
